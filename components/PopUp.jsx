    ...
    >
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="absolute top-3 right-3 sm:top-4 sm:right-4 w-9 h-9 bg-[#1e293b] text-white rounded-full flex items-center justify-center text-lg font-bold hover:shadow-xl transition-all"
        >
          ✕
        </motion.button>
        ...
        >
          ...
          <motion.button
            ...
            className={`w-full text-white font-semibold py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 shadow-lg hover:shadow-xl transition duration-300 ${
