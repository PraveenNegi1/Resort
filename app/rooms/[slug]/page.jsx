    ...
    <div className="min-h-screen font-sans bg-gradient-to-b from-cream-100 to-cream-200 text-gray-900">
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-3xl sm:text-4xl font-bold text-teal-600 mb-10 bg-teal-100/50 px-6 py-3 rounded-xl inline-block shadow-md"
          >
            ₹{room.price}{" "}
            <span className="text-lg font-medium text-teal-800">/ night</span>
          </motion.p>
            ...
            <ul className="flex flex-wrap gap-3 mb-10">
              {room.amenities.map((item, index) => (
                <motion.li
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-teal-100 text-teal-900 px-4 py-2 rounded-full text-sm font-medium shadow-sm transition-all duration-300"
                >
                  {item}
                </motion.li>
              ))}
            ...
            <motion.div variants={itemVariants}>
              ...
              <ul className="space-y-4 text-gray-700 text-base">
                {room.features.map((feature, index) => (
                  ...
                  >
                    <span className="w-2 h-2 mt-2 bg-teal-500 rounded-full" />
                    <span>{feature}</span>
                  </motion.li>
                ))}
              </ul>
          ...
          <motion.div variants={itemVariants} className="mt-16 text-center">
            <Link
              href="/contact"
              className="inline-block px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white text-lg rounded-full shadow-lg transition-all duration-300 font-serif tracking-wide"
            >
              Book This Room
            </Link>
          </motion.div>
